		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				<form class="form-horizontal" role="form"
					action="<%=basePath%>CompanyAccountService/CompanyAccountServiceChangePassword_changeAddDealpassword.action">
					<div class="form-group">
						<label for="addDealpassword" class="col-sm-2 control-label">请输入你当前的登录密码:</label>
						<div class="col-sm-10">
							<input class="form-control" id="addDealpassword" type="password"
								name="addDealpassword" />
						</div>
					</div>
					<div class="form-group">
